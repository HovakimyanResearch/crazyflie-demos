...
class PathCmd:
    def __init__(self):    
        ...
        self.pub1 = rospy.Publisher('/q2/cmd_path', Twist, queue_size=1)
        ...
        self.path1 = path(np.array([0.0, 0.0, 0.0]), np.array([0.0, 0.0, 1.0]), 0.0,     5.0)
        ##### hovering 5 sec #####
        self.path2 = path(np.array([0.0, 0.0, 1.0]), np.array([1.5, 0.0, 1.0]), 10.0,  15.0)
        ##### hovering 5 sec #####
        self.path3 = path(np.array([1.5, 0.0, 1.0]), np.array([1.5, 1.5, 1.0]), 20.0,  25.0)
        ##### hovering 5 sec #####
        self.path4 = path(np.array([1.5, 1.5, 1.0]), np.array([0.0, 1.5, 1.0]), 30.0,  35.0)
        ##### hovering 5 sec #####
        self.path5 = path(np.array([0.0, 1.5, 1.0]), np.array([0.0, 0.0, 1.0]), 40.0,  45.0)
        ##### hovering 5 sec #####
        self.path6 = path(np.array([0.0, 0.0, 1.0]), np.array([0.0, 0.0, 0.0]), 50.0,  55.0)
